((ace-window :source "elpaca-menu-lock-file" :recipe
 ...
 (claude-code-ide :source "elpaca-menu-lock-file" :recipe
		  (:source nil :package "claude-code-ide" :id
			   claude-code-ide :host github :repo
			   "manzaltu/claude-code-ide.el" :type git
 ...
 (claudemacs :source "elpaca-menu-lock-file" :recipe
	     (:source nil :package "claudemacs" :id claudemacs :host
 ...
 (cmake-mode :source "elpaca-menu-lock-file" :recipe
	     (:package "cmake-mode" :fetcher git :url
		       ...
		       :files ("Auxiliary/*.el") :source "MELPA" :id
		       cmake-mode :type git :protocol https :inherit t
		       :depth treeless :ref
		       "4f7e48461134988bd5eeb22aaf07ad703ab594c6"))
   ...
   (:package "cond-let" :fetcher github :repo "tarsius/cond-let"
	     ...
	     ("*.el" "*.el.in" "dir" "*.info" "*.texi" "*.texinfo"
	      ...
	      (:exclude ".dir-locals.el" "test.el" "tests.el"
			...
			"*-pkg.el"))
	     :source "MELPA" :id cond-let :host github :type git
	     :protocol https :inherit t :depth treeless :ref
 ...
 (eat :source "elpaca-menu-lock-file" :recipe
      (:package "eat" :repo "akib/emacs-eat" :tar "0.9.4" :host
		codeberg :files
		...
		:source "NonGNU ELPA" :id eat :type git :branch
		"master" :protocol https :inherit t :depth treeless
		:ref "c8d54d649872bfe7b2b9f49ae5c2addbf12d3b99"))
 (eca :source "elpaca-menu-lock-file" :recipe
      (:package "eca" :fetcher github :repo
		"editor-code-assistant/eca-emacs" :files
		("*.el" "*.el.in" "dir" "*.info" "*.texi" "*.texinfo"
		 "doc/dir" "doc/*.info" "doc/*.texi" "doc/*.texinfo"
		 "lisp/*.el" "docs/dir" "docs/*.info" "docs/*.texi"
		 "docs/*.texinfo"
		...
		:protocol https :inherit t :depth treeless :ref
		"bda08541fda4ce57a97e651516829c3df7e99e26"))
 ...
 (eglot-booster :source "elpaca-menu-lock-file" :recipe
		(:source nil :package "eglot-booster" :id
			 ...
			 "jdtsmith/eglot-booster" :type git :protocol
			 https :inherit t :depth treeless :ref
 ...
 (elpaca :source
   ...
   (:source nil :package "elpaca" :id elpaca :repo
	    ...
	    "d50549dba77a479a9c7f2977eb53821216208797" :depth 1
 ...
 (elpaca-use-package :source "elpaca-menu-lock-file" :recipe
		     (:package "elpaca-use-package" :wait t :repo
			       ...
			       https :inherit t :depth treeless :ref
			       "d50549dba77a479a9c7f2977eb53821216208797"))
 (emacs-mcp :source "elpaca-menu-lock-file" :recipe
	    (:source nil :package "emacs-mcp" :id emacs-mcp :host
		     github :repo "mpontus/emacs-mcp" :type git
		     :protocol https :inherit t :depth treeless :ref
		     "0be920e2531bccf11bcfb7c28502871b88bc1242"))
 ...
 (embark :source "elpaca-menu-lock-file" :recipe
	 (:package "embark" :repo "oantolin/embark" :fetcher github
		   ...
		   https :inherit t :depth treeless :ref
		   "66429937eb46a45064f17b74b8fa94eecd8a9227"))
 (embark-consult :source "elpaca-menu-lock-file" :recipe
		 (:package "embark-consult" :repo "oantolin/embark"
			   ...
			   :inherit t :depth treeless :ref
			   "66429937eb46a45064f17b74b8fa94eecd8a9227"))
 (enhanced-evil-paredit :source "elpaca-menu-lock-file" :recipe
			(:package "enhanced-evil-paredit" :fetcher
				  github :repo
				  "jamescherti/enhanced-evil-paredit.el"
				  :files
				  ("*.el" "*.el.in" "dir" "*.info"
				   "*.texi" "*.texinfo" "doc/dir"
				   "doc/*.info" "doc/*.texi"
				   ...
				   (:exclude ".dir-locals.el"
					     ...
					     "*-pkg.el"))
				  :source "MELPA" :id
				  enhanced-evil-paredit :type git
				  :protocol https :inherit t :depth
				  treeless :ref
				  "2209fceae2acab381facb1865ac41b28c2938f10"))
	   ...
	   (:package "evil-owl" :repo "mamapanda/evil-owl" :fetcher
		     ...
		     ("*.el" "*.el.in" "dir" "*.info" "*.texi"
		      ...
		      (:exclude ".dir-locals.el" "test.el" "tests.el"
				"*-test.el" "*-tests.el" "LICENSE"
				"README*" "*-pkg.el"))
		     :source "MELPA" :id evil-owl :type git :protocol
		     https :inherit t :depth treeless :ref
 ...
 (filladapt :source "elpaca-menu-lock-file" :recipe
	    (:package "filladapt" :repo
		      ("https://github.com/emacsmirror/gnu_elpa"
		       . "filladapt")
		      :tar "2.12.2" :host gnu :branch
		      "externals/filladapt" :files
		      ("*" (:exclude ".git")) :source "GNU ELPA" :id
		      filladapt :type git :protocol https :inherit t
		      :depth treeless :ref
	...
	(:package "flash" :fetcher github :repo "ftzm/flash" :files
		  ("*.el" "*.el.in" "dir" "*.info" "*.texi"
		   ...
		   (:exclude ".dir-locals.el" "test.el" "tests.el"
			     "*-test.el" "*-tests.el" "LICENSE"
			     "README*" "*-pkg.el"))
		  :source "MELPA" :id flash :host github :branch
		  "overlay-expand" :type git :protocol https :inherit
		  t :depth treeless :ref
		  "df02f863a390ca0e9e4c268168830aa7df24313a"))
 ...
 (geiser :source "elpaca-menu-lock-file" :recipe
	 (:package "geiser" :fetcher gitlab :repo
		   "emacs-geiser/geiser" :files
		   ("elisp/*.el" "doc/dir" "doc/geiser.texi") :source
		   "MELPA" :id geiser :type git :protocol https
		   :inherit t :depth treeless :ref
		   "185191df527b51ce521084f8c32030e87dabb5e9"))
 (geiser-chez :source "elpaca-menu-lock-file" :recipe
	      (:package "geiser-chez" :fetcher gitlab :repo
			"emacs-geiser/chez" :files
			(:defaults ("src" "src/*")) :source "MELPA"
			:id geiser-chez :type git :protocol https
			:inherit t :depth treeless :ref
		...
		(:package "gruvbox-theme" :fetcher github :repo
			  ...
			  ("*.el" "*.el.in" "dir" "*.info" "*.texi"
			   ...
			   (:exclude ".dir-locals.el" "test.el"
				     ...
				     "*-tests.el" "LICENSE" "README*"
				     "*-pkg.el"))
			  :source "MELPA" :id gruvbox-theme :type git
			  :protocol https :inherit t :depth treeless
			  :ref
			  ...
			  (:package "jetbrains-darcula-theme" :fetcher
				    ...
				    ("*.el" "*.el.in" "dir" "*.info"
				     ...
				     (:exclude ".dir-locals.el"
					       ...
					       "README*" "*-pkg.el"))
				    :source "MELPA" :id
				    jetbrains-darcula-theme :type git
				    :protocol https :inherit t :depth
				    treeless :ref
	       ...
	       (:package "jsonnet-mode" :fetcher github :repo
			 ...
			 ("*.el" "*.el.in" "dir" "*.info" "*.texi"
			  ...
			  (:exclude ".dir-locals.el" "test.el"
				    ...
				    "*-tests.el" "LICENSE" "README*"
				    "*-pkg.el"))
			 :source "MELPA" :id jsonnet-mode :type git
			 :protocol https :inherit t :depth treeless
			 :ref
	   ...
	   (:package "libmpdel" :fetcher github :repo "mpdel/libmpdel"
		     ...
		     ("*.el" "*.el.in" "dir" "*.info" "*.texi"
		      ...
		      (:exclude ".dir-locals.el" "test.el" "tests.el"
				"*-test.el" "*-tests.el" "LICENSE"
				"README*" "*-pkg.el"))
		     :source "MELPA" :id libmpdel :type git :protocol
		     https :inherit t :depth treeless :ref
 ...
 (lsp-metals :source "elpaca-menu-lock-file" :recipe
	     (:package "lsp-metals" :repo "emacs-lsp/lsp-metals"
		       ...
		       :source "MELPA" :id lsp-metals :type git
		       :protocol https :inherit t :depth treeless :ref
 ...
 (magit :source "elpaca-menu-lock-file" :recipe
	(:package "magit" :fetcher github :repo "magit/magit" :files
		  ...
		  :inherit t :depth treeless :ref
		  "0988e1564bbe5a08f876fa0d78eb9d587c704121"))
	...
	(:package "mpdel" :fetcher github :repo "mpdel/mpdel" :files
		  ("*.el" "*.el.in" "dir" "*.info" "*.texi"
		   ...
		   (:exclude ".dir-locals.el" "test.el" "tests.el"
			     "*-test.el" "*-tests.el" "LICENSE"
			     "README*" "*-pkg.el"))
		  :source "MELPA" :id mpdel :type git :protocol https
		  :inherit t :depth treeless :ref
	  ...
	  (:package "navigel" :fetcher github :repo
		    ...
		    ("*.el" "*.el.in" "dir" "*.info" "*.texi"
		     ...
		     (:exclude ".dir-locals.el" "test.el" "tests.el"
			       "*-test.el" "*-tests.el" "LICENSE"
			       "README*" "*-pkg.el"))
		    :source "MELPA" :id navigel :type git :protocol
		    https :inherit t :depth treeless :ref
 ...
 (paren-face :source "elpaca-menu-lock-file" :recipe
	     (:package "paren-face" :fetcher github :repo
		       ...
		       :old-names (parenface) :source "MELPA" :id
		       paren-face :type git :protocol https :inherit t
		       :depth treeless :ref
	      ...
	      (:package "perspective" :fetcher github :repo
			...
			("*.el" "*.el.in" "dir" "*.info" "*.texi"
			 ...
			 (:exclude ".dir-locals.el" "test.el"
				   "tests.el" "*-test.el" "*-tests.el"
				   "LICENSE" "README*" "*-pkg.el"))
			:source "MELPA" :id perspective :type git
			:protocol https :inherit t :depth treeless
			:ref
			"f384207b12f07353e0a6d148de6bd332334fafcd"))
	      ...
	      (:package "racket-mode" :fetcher github :repo
			...
			(:defaults "*.rkt" ("racket" "racket/*")
				   (:exclude "racket/example/*"
					     "racket/test/*"))
			:source "MELPA" :id racket-mode :type git
			:protocol https :inherit t :depth treeless
			:ref
		 ...
		 (:package "real-auto-save" :fetcher github :repo
			   ...
			   ("*.el" "*.el.in" "dir" "*.info" "*.texi"
			    ...
			    (:exclude ".dir-locals.el" "test.el"
				      ...
				      "*-tests.el" "LICENSE" "README*"
				      "*-pkg.el"))
			   :source "MELPA" :id real-auto-save :type
			   git :protocol https :inherit t :depth
			   treeless :ref
	   ...
	   (:package "sbt-mode" :fetcher github :repo
		     ...
		     ("*.el" "*.el.in" "dir" "*.info" "*.texi"
		      ...
		      (:exclude ".dir-locals.el" "test.el" "tests.el"
				"*-test.el" "*-tests.el" "LICENSE"
				"README*" "*-pkg.el"))
		     :source "MELPA" :id sbt-mode :type git :protocol
		     https :inherit t :depth treeless :ref
 ...
 (vue-ts-mode :source "elpaca-menu-lock-file" :recipe
	      (:source nil :package "vue-ts-mode" :id vue-ts-mode
		       :host github :repo "8uff3r/vue-ts-mode" :type
 ...
 (web-server :source "elpaca-menu-lock-file" :recipe
	     (:package "web-server" :fetcher github :repo
			...
			(:exclude ".dir-locals.el" "test.el"
				  "tests.el" "*-test.el" "*-tests.el"
				  "LICENSE" "README*" "*-pkg.el"))
		       :source "MELPA" :id web-server :type git
		       :protocol https :inherit t :depth treeless :ref
	...
	(:package "winum" :fetcher github :repo "deb0ch/emacs-winum"
		  ...
		  ("*.el" "*.el.in" "dir" "*.info" "*.texi"
		   ...
		   (:exclude ".dir-locals.el" "test.el" "tests.el"
			     "*-test.el" "*-tests.el" "LICENSE"
			     "README*" "*-pkg.el"))
		  :source "MELPA" :id winum :type git :protocol https
		  :inherit t :depth treeless :ref
