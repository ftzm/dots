...
- [x] 1.1 Change WebDAV nginx to listen on 127.0.0.1:8080 only (machines/nuc/default.nix)
- [x] 1.2 Remove all nginx virtualHosts except WebDAV backend (machines/nuc/default.nix)
