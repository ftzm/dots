    ...
    home-manager.users.ftzm = {
      ...
      in {
        ...
        config = {
          ...
          keybindings = let
            modifier =
              config.home-manager.users.ftzm.wayland.windowManager.sway.config.modifier;
          ...
          modes.org = let md = "swaymsg mode default;";
          in {
      ...
      systemd.user.services.flashfocus = {
        ...
        Service = {
          ExecStart =
            "${pkgs.flashfocus}/bin/flashfocus -o 0.7 -t 150 -l never";
