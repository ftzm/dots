...
t () {
    nt_command="~/dev/tempo/dolly/tempoc/bin/tempoc $@"
    old_loc="$PWD"
    (cd ~/dev/tempo/dolly/src/infra && nix-shell --command "cd $old_loc; $nt_command")
...
# bashmarks
# unalias conflicting aliases of plugins
unalias l
unalias g
source ~/.bashmarks.sh
