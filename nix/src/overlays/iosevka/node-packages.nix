...
let
  sources = {
    ...
    "cldr-5.5.4" = {
      ...
      version = "5.5.4";
      src = fetchurl {
        url = "https://registry.npmjs.org/cldr/-/cldr-5.5.4.tgz";
        sha512 = "KmazRGg5srChDASXQiOXANqBMFAOoAxWbfwxXdwHGpl2nPK1q6FaHtp8XAcKXpD+Cy1MjXz7djdtTAR/9oe8og==";
      };
    };
    "cli-cursor-2.1.0" = {
      name = "cli-cursor";
...
in
{
  "iosevka-build-deps-./." = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."primitive-quadify-off-curves-0.6.3"
